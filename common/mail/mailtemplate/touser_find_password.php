...
<p style="padding-left: 30px;"><a href="{url route=\'find_password/set_password\' id=$user.userid activation=$word baseUrl=$site_url}">{url route=\'find_password/set_password\' id=$user.userid activation=$word}</a></p>
